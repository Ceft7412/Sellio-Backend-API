...
CREATE TABLE "product_images" (
	...
	"product_id" uuid NOT NULL,
	"image_url" text NOT NULL,
	"image_type" varchar(20) DEFAULT 'product' NOT NULL,
...
ALTER TABLE "reports" ADD CONSTRAINT "reports_transaction_id_transactions_id_fk" FOREIGN KEY ("transaction_id") REFERENCES "public"."transactions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_meetup_proposed_by_users_id_fk" FOREIGN KEY ("meetup_proposed_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "device_tokens_token_idx" ON "device_tokens" USING btree ("expo_push_token");--> statement-breakpoint
...
CREATE INDEX "product_images_image_type_idx" ON "product_images" USING btree ("image_type");--> statement-breakpoint
